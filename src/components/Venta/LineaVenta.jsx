...
function LineaVenta({ venta, local }) {
  ...
  return (
    <div className='bg-blanco w-full flex justify-between border border-negro-2 '>
      ...
      <div className='flex justify-center border border-negro-2 h-full py-2 px-5 w-2/12 items-center'><label>{localo.nombre}</label></div>
      ...
      <div className='flex justify-center border border-negro-2 h-full py-2 px-5 w-1/12 items-center'><label>{venta.productos.length }</label></div>
