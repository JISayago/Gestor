...
function CabeceraListadoVentas() {
  return (
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-1/12'><label className='font-bold text-white overflow-hidden text-ellipsis whitespace-nowrap'>N°</label></div>
