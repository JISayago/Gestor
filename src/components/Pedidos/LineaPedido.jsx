...
function LineaPedido({ pedido }) {
  ...
  return (
    <div className='bg-blanco w-full flex justify-between border border-negro-2 '>
      ...
      <div className='flex justify-center border border-negro-2 h-full py-2 px-5 w-1/12 items-center'><label>{pedido.numeroReferencia}</label></div>
      <div className='flex justify-center border border-negro-2 h-full py-2 px-5 w-1/12 items-center'><label>{pedido.local.nombre}</label></div>
