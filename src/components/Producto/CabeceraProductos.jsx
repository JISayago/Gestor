...
function CabeceraProductos() {
  return (
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-1/12'><label className='font-bold text-white'>Color</label></div>
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-2/12'><label className='font-bold text-white'>Acciones</label></div>
  </div>
  )
}
