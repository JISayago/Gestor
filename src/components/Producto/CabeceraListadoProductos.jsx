...
function CabeceraListadoProductos() {
  return (
    <div className="w-full p-3 flex justify-evenly items-center">
            <div className='w-2/6'>
              <h1 className='p-2 text-2xl text-white font-bolder underline decoration-2 underline-offset-4'>Listado de Productos</h1>
            </div>
...
export default CabeceraListadoProductos