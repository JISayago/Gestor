...
function CabeceraProveedores() {
  return (
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-2/12'><label className='font-bold text-white'>Cta Cte</label></div>
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-3/12'><label className='font-bold text-white'>Email</label></div>
