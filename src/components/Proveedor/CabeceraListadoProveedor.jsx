...
function CabeceraListadoProveedor({titulo}) {
  return (
      ...
      <div className='w-2/6'>
        {
          !titulo ?
            <></> :
              <h1 className='p-2 text-2xl text-white font-bolder underline decoration-2 underline-offset-4'>Listado de Proveedores</h1>
        }
            </div>
...
export default CabeceraListadoProveedor