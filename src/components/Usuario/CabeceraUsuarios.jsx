...
function CabeceraUsuarios() {
  return (
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-2/12'><label className='font-bold text-white'>Usuario</label></div>
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-1/12'><label className='font-bold text-white'>Dni</label></div>
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-3/12 overflow-hidden text-ellipsis whitespace-nowrap'><label className='font-bold text-white'>Email</label></div>
    ...
    <div className='border border-negro-2 h-full py-2 px-5 text-center w-1/12'><label className='font-bold text-white'>Estado</label></div>
